\hypertarget{md_spec_autotoc_md5}{}\doxysection{Az ötlet leírása}\label{md_spec_autotoc_md5}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_spec_autotoc_md7}{}\doxysection{Megoldási ötlet (vázlat)}\label{md_spec_autotoc_md7}
