\label{index_md_spec}%
\Hypertarget{index_md_spec}%
\hypertarget{index_autotoc_md5}{}\doxysection{Az ötlet leírása}\label{index_autotoc_md5}
...
\includegraphics[height=\baselineskip,keepaspectratio=true]{simulationEditor.png}%1. ábra -\/ Szimuláció előkészítése.
\end{DoxyInlineImage}
...
\begin{DoxyItemize}
\item Olyan diagram(idő szerint), ahol ábrázolva vannak a fontos adatok. (Ferőzöttek, halottak, gyógyultak, stb)
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{index_autotoc_md7}{}\doxysection{Megoldási ötlet (vázlat)}\label{index_autotoc_md7}
